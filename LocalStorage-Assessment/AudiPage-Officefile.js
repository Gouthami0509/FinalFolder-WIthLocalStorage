    ...
    $(document).ready(function(){
        var AvailableLocations = ["Jaynagar","Nagarbhavi","Malleshwaram","Indranagar"]
...
//fetching booking details of user--------------
            $("#IdBookingConfrimBtn").click(function () {
                var GetUserBookingDetails = JSON.parse(localStorage.getItem("UserBookingDetails"));
                if(GetUserBookingDetails == null){
                ...
                GetUserBookingDetails.push(BookingDetails);
                localStorage.setItem("UserBookingDetails",JSON.stringify(GetUserBookingDetails));
                //localStorage.setItem("UserBookingDetails", JSON.stringify(BookingDetails));
                // alert(username + addresss + mobile +emailID ) ;
               // $("#jqgrid").addRowData("", Data,);
               // $("#IdJqGrid").jqGrid('addRowData', "new", BookingDetails);
                // var PickupLocation = $("#IdBFPickUpLocation").val();
                // var PickupDate = $("#IdBFPickUpDate").val();
                // var DropLocation = $("#IdBFDropLocation").val();
                // var DropDate = $("#IdBFDropDate").val();
                // $("#")
            });
